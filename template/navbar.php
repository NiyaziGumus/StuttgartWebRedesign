...
<head>
  ...
  <link rel="stylesheet" href="/StuttgartWebRedesign/bootstrap/custom.css">
...
<body>
  <div class="container d-none d-lg-block">
    <div class="row">
      ...
      <div class="col my-3 d-lg-flex justify-content-center">
      ...
      <div class="col d-flex justify-content-center my-3 me-4">
        <a class="navbar-brand light-theme mx-1" href="#" data-bs-theme-value="light" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Hell-Modus"><i class="bi bi-sun-fill" style="font-size: 1.3rem;"></i></a>
        <a class="navbar-brand dark-theme mx-1" href="#" data-bs-theme-value="dark" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Dunkel-Modus"><i class="bi bi-moon-stars-fill" style="font-size: 1.2rem;"></i></a>
        <a class="navbar-brand custom-theme mx-1" href="#" data-bs-theme-value="custom" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Stuttgart-Thema"><img src="/StuttgartWebRedesign/img/farbeIkon.svg" alt="Farbikone" width="20" height="24"></a>
        <div class="vr mx-3"></div>
        <a class="navbar-brand mx-1 svg-icon font-size-down" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Schrift verkleinern"><img src="/StuttgartWebRedesign/img/fontSizeDown.svg" alt="A-" width="18" height="18"></a>
        <a class="navbar-brand mx-1 svg-icon font-size-up" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Schrift vergrößern"><img src="/StuttgartWebRedesign/img/fontSizeUp.svg" alt="A+" width="24" height="24"></a>
      </div>
    </div>
  </div>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      <a class="navbar-brand d-block svg-icon d-lg-none" href="/StuttgartWebRedesign/index.php">
